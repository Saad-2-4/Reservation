        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="<?php echo e(route('admin.categories.index')); ?>"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Categories</a>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Saad Afkir\Desktop\Laravel\Reservation-table\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>